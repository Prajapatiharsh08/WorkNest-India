  ...
  return (
    <main className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-20 max-w-4xl">
        <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-8 text-center">Terms & Conditions</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">2. Partnership Program</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Our partnership program allows individuals to become financial advisors and earn commissions by referring
              banking, financial services, and insurance products. By joining our program, you agree to:
            </p>
            <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
              <li>Provide accurate and complete information during registration</li>
              <li>Maintain the confidentiality of your account credentials</li>
              <li>Comply with all applicable laws and regulations</li>
              <li>Represent our products and services accurately and ethically</li>
              <li>Not engage in any fraudulent or misleading practices</li>
            </ul>
          </section>

          <section>
            <h2 className="text-2xl font-bold text-foreground mb-4">3. Commission Structure</h2>
            <p className="text-muted-foreground leading-relaxed">
              Partners earn commissions based on successful referrals and transactions. Commission rates are subject to
              change and will be communicated to partners in advance. Commissions are paid according to our payment
              schedule and terms, which may vary based on the product or service referred.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              We reserve the right to modify these Terms and Conditions at any time. We will notify partners of any
              material changes via email or through our platform. Your continued use of our services after such changes
